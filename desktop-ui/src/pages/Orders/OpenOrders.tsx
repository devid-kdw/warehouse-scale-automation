import { Container, Title, Table, Badge, Button, TextInput, Group, Stack } from '@mantine/core';
        ...
        <Container size="xl" className="page-container">
            <Stack gap="md">
                <Group justify="space-between">
                    <Title order={2}>{t('nav.openOrders')}</Title>
                    <Button
                    ...
                    <Table.Tbody>
                        ...
                        {filteredOrders.map((order: Order) => (
                            ...
                            >
                                ...
                                <Table.Td>
                                    <Badge color="blue">{t('orders.open')}</Badge>
                                </Table.Td>
                            </Table.Tr>
                        ))}
                    </Table.Tbody>
